...
if ( ! function_exists( 'authentic_setup' ) ) :
/**
...
function authentic_setup() {
	 ...
	 * If you're building a theme based on Authentic, use a find and replace
	 * to change 'authentic' to the name of your theme in all the template files.
	 */
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary', 'authentic' ),
	) );
	...
	add_theme_support( 'custom-background', apply_filters( 'authentic_custom_background_args', array(
 ...
 */
function authentic_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'authentic_content_width', 640 );
}
add_action( 'after_setup_theme', 'authentic_content_width', 0 );
...
function authentic_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'authentic' ),
		'id'            => 'sidebar-1',
		'description'   => '',
...
//Adding the Flexslider Script and Javascript File

	wp_enqueue_script( 'authentic-flexslider', get_stylesheet_directory_uri() . '/js/jquery.flexslider-min.js', array('jquery'), '2.6.0', true );
	
	wp_enqueue_script( 'authentic-flexslider.js', get_template_directory_uri() . '/js/flexslider.js', array('jquery'), '1.0', true);
...
//Calling file controlling theme options.
